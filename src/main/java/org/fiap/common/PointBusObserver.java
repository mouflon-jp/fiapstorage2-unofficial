...
public abstract class PointBusObserver {

	PointBus m_PointBus;
	
	public void setPointBus(PointBus pointBus){
		m_PointBus=pointBus;
	}
	
	public PointBus getPointBus(){
		return m_PointBus;
	}
	
	public abstract void recvUpdate(org.fiap.common.PointData o) ;
	
	public void sendUpdate(org.fiap.common.PointData o){
		m_PointBus.update(o, this);
	}
