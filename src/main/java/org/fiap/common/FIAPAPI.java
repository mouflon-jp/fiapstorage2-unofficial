...
public interface FIAPAPI {
	Transport query(Transport t, String initiator_ip) throws org.fiap.common.FIAPException, java.io.IOException;
	Transport data(Transport t, String initiator_ip) throws org.fiap.common.FIAPException, java.io.IOException;
}
