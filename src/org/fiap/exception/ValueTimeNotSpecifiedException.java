...
public class ValueTimeNotSpecifiedException extends FIAPException {

	public ValueTimeNotSpecifiedException(){
		super();
		m_ErrorType="VALUE_TIME_NOT_SPECIFIED";
	}
	
	public ValueTimeNotSpecifiedException(String msg){
		super(msg);
		m_ErrorType="VALUE_TIME_NOT_SPECIFIED";
	} 
}
