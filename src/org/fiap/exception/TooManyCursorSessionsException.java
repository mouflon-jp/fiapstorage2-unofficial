...
public class TooManyCursorSessionsException extends FIAPException {

	public TooManyCursorSessionsException(){
		super();
		m_ErrorType="TOO_MANY_CURSOR_SESSIONS";
	}
	
	public TooManyCursorSessionsException(String msg){
		super(msg);
		m_ErrorType="TOO_MANY_CURSOR_SESSIONS";
	} 
}
