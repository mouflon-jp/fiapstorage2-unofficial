...
public class TooManyTrapQueriesException extends FIAPException {

	public TooManyTrapQueriesException(){
		super();
		m_ErrorType="TOO_MANY_TRAP_QUERIES";
	}
	
	public TooManyTrapQueriesException(String msg){
		super(msg);
		m_ErrorType="TOO_MANY_TRAP_QUERIES";
	} 
}
