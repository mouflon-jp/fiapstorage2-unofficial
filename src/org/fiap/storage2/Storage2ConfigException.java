...
public class Storage2ConfigException extends FIAPException {

	public Storage2ConfigException(){
		super();
		m_ErrorType="SERVER_ERROR";
	}
	
	public Storage2ConfigException(String msg){
		super(msg);
		m_ErrorType="SERVER_ERROR";
	} 
}
