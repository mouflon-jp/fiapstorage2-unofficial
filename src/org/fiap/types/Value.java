 ...
 */
    ...
    public static class Factory{
                ...
                public static Value fromString(java.lang.String value,
                ...
                public static Value fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return Value.Factory.fromString(content,namespaceUri);
                    } else {
                       return Value.Factory.fromString(content,"");
                    }
                }
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"value".equals(type)){
                                ...
                                return (Value)org.fiap.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
