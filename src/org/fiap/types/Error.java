 ...
 */
    ...
    public static class Factory{
                ...
                public static Error fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return Error.Factory.fromString(content,namespaceUri);
                    } else {
                       return Error.Factory.fromString(content,"");
                    }
                }
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"error".equals(type)){
                                ...
                                return (Error)org.fiap.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
